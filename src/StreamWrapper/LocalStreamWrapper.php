...
namespace MakinaCorpus\Files\StreamWrapper;
...
class LocalStreamWrapper
{
    ...
    {
        // This may not work as expected, nevertheless, this stream wrapper
        // is primarily here for edge cases compoatibility, you should not
        // rely upon it for anything else than reading data.
        \unlink($uri);
    }
